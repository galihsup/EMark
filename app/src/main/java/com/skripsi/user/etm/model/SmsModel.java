...
public class SmsModel {
    @SerializedName("id_smsmarketing")
    public int idt;
    ...
    public SmsModel(int idt, int ids, String nama, String nohp, String asalSekolah, String kelas, String jurusan, String jurusanKuliah, String ptn, String pts, String respon1, String respon2, String respon3) {
        this.idt = idt;
        this.ids = ids;
        this.nama = nama;
        this.nohp = nohp;
