...
public class EditSmsSiswaActivity extends AppCompatActivity {
    ...
    TextInputEditText etNama,etNohp,etAsal,etJurusan,etJur,etPtn,etPts,etRespon1,etRespon2,etRespon3;
    String ambilTanggal="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_sms_siswa);

        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
        editor = sharedPrefs.edit();

        ivExit = (ImageView) findViewById(R.id.iv_edit_sms_exit);
        ivSave = (ImageView) findViewById(R.id.iv_edit_sms_save);
        ...
        etNama = (TextInputEditText) findViewById(R.id.tv_sms_editname);
        etNohp = (TextInputEditText) findViewById(R.id.tv_sms_editphone);
        etAsal = (TextInputEditText) findViewById(R.id.tv_sms_editasalsekolah);
        etJurusan = (TextInputEditText) findViewById(R.id.tv_sms_editjurusansekolah);
        etJur = (TextInputEditText) findViewById(R.id.tv_sms_editpilih_jurusan);
        etPtn = (TextInputEditText) findViewById(R.id.tv_sms_editpilih_ptn);
        etPts = (TextInputEditText) findViewById(R.id.tv_sms_editpilih_pts);
        etRespon1 = (TextInputEditText) findViewById(R.id.tv_sms_editrespon1);
        etRespon2 = (TextInputEditText) findViewById(R.id.tv_sms_editrespon2);
        etRespon3 = (TextInputEditText) findViewById(R.id.tv_sms_editrespon3);
        civProfile = (CircleImageView) findViewById(R.id.edprofile_sms_image);
    ...
    public void getViewSiswa(String id) {
        ...
        loading.show();
        String url = Constant.ENDPOINT_GETDATA_SMSMARKETING+id;
            ...
            public void onResponse(String response){
                ...
                try{
                    ...
                    if (json.getInt("status") == 200) {
                        ...
                        Toast.makeText(EditSmsSiswaActivity.this,msg,Toast.LENGTH_LONG).show();
                    }
                }
    ...
    public void prosesEdit(){
        ...
        loading.setMessage("Loading...");
        loading.show();
        String urlHal = Constant.ENDPOINT_EDIT_SMS_SISWA+id_siswa;
    ...
    private Response.ErrorListener listenerError() {
        return new Response.ErrorListener() {
            ...
            public  void onErrorResponse(VolleyError error) {
                ...
                Log.e("Error", String.valueOf(error));
                Toast.makeText(EditSmsSiswaActivity.this,error.toString(),Toast.LENGTH_LONG).show();
            }
        };
    }
        ...
        return new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    {
                        Toast.makeText(EditSmsSiswaActivity.this,message,Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(EditSmsSiswaActivity.this, HomeActivity.class);
