...
public class EditTeleSiswaActivity extends AppCompatActivity {
    ...
    TextInputEditText etNama,etNohp,etAsal,etJurusan,etJur,etPtn,etPts,etRespon1,etRespon2,etRespon3,etOperator,etPetugas;
    String ambilTanggal="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_tele_siswa);

        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
        editor = sharedPrefs.edit();

        ivExit = (ImageView) findViewById(R.id.iv_edit_tele_exit);
        ivSave = (ImageView) findViewById(R.id.iv_edit_tele_save);
        ...
        etNama = (TextInputEditText) findViewById(R.id.tv_tele_editname);
        etNohp = (TextInputEditText) findViewById(R.id.tv_tele_editphone);
        etAsal = (TextInputEditText) findViewById(R.id.tv_tele_editasalsekolah);
        etJurusan = (TextInputEditText) findViewById(R.id.tv_tele_editjurusansekolah);
        etJur = (TextInputEditText) findViewById(R.id.tv_tele_editpilih_jurusan);
        etPtn = (TextInputEditText) findViewById(R.id.tv_tele_editpilih_ptn);
        etPts = (TextInputEditText) findViewById(R.id.tv_tele_editpilih_pts);
        etRespon1 = (TextInputEditText) findViewById(R.id.tv_tele_editrespon1);
        etRespon2 = (TextInputEditText) findViewById(R.id.tv_tele_editrespon2);
        etRespon3 = (TextInputEditText) findViewById(R.id.tv_tele_editrespon3);
        etOperator = (TextInputEditText) findViewById(R.id.tv_tele_editoperator);
        etPetugas = (TextInputEditText) findViewById(R.id.tv_tele_editpetugas);
        civProfile = (CircleImageView) findViewById(R.id.edprofile_tele_image);
    ...
    public void getViewSiswa(String id) {
        ...
        loading.show();
        String url = Constant.ENDPOINT_GETDATA_TELEMARKETING+id;
            ...
            public void onResponse(String response){
                ...
                try{
                    ...
                    if (json.getInt("status") == 200) {
                        ...
                        etOperator.setText(data.getString("etm_operator").toString());
                        etPetugas.setText(data.getString("etm_petugas").toString());
                        isiPhoto(img);
                    } else {
                        Toast.makeText(EditTeleSiswaActivity.this,msg,Toast.LENGTH_LONG).show();
                    }
                }
    ...
    public void prosesEdit(){
        ...
        loading.setMessage("Loading...");
        loading.show();
        String urlHal = Constant.ENDPOINT_EDIT_TELE_SISWA+id_siswa;
        Log.d("link ni: ", urlHal);
        StringRequest req =
                new StringRequest(Request.Method.POST, urlHal, listenerSuccess(), listenerError()){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("operator", etOperator.getText().toString());
                params.put("petugas", etPetugas.getText().toString());
...
//                Log.e("Error", String.valueOf(error));
//                Toast.makeText(EditTeleSiswaActivity.this,error.toString(),Toast.LENGTH_LONG).show();
                Toast.makeText(EditTeleSiswaActivity.this,"Sukses Ubah Data",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(EditTeleSiswaActivity.this, TelemarketingFragment.class);
        ...
        return new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    {
                        Toast.makeText(EditTeleSiswaActivity.this,message,Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(EditTeleSiswaActivity.this, HomeActivity.class);
                        startActivity(intent);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
